        ...
        <div class="col-md-8">        
            ...
            <!-- Default box -->
                <div class="box">
                    ...
                    ?>
                        <!--post enviar algo al servidor-->
                        <!--get obtener algo del servidor-->
                        <form role="form" name="guardar-registro"  id="guardar-registro-archivo" method="post" action="modelo-invitado.php" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="biografia_invitado" name="biografia_invitado" rows="8" placeholder="Biografia">value="<?php echo $invitado['descripcion']; ?></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="help-block">Añade la imagen del invitado aqui.</p>
                                </div>
