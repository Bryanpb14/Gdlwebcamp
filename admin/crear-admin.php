...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Crear Administrador
            <small>llena el formulario para crear un admnistrador</small>
        </h1>                
    </section>
                        ...
                        <form role="form" name="guardar-registro"  id="guardar-registro" method="post" action="modelo-admin.php">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="repetir_password" name="password" placeholder="Password para Iniciar Sesion">
