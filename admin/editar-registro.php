                                            ...
                                            <li class="col-md-4">
                                                <div class="tabla-precio text-center">
                                                    ...
                                                    <div class="orden">
                                                        ...
                                                        <input value="<?php echo $boletos['pase_cempleto']['cantidad']; ?>" type="number" min="0" id="pase_completo" size="3" name="boletos[completo][cantidad]" placeholder="0">
                                    ...
                                    <div id="eventos" class="eventos clearfix">
                                        ...
                                        <div class="caja ">
                                            <?php
                                                ...
                                                $id_eventos_registrados = json_encode($eventos, true);
